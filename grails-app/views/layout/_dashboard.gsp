...
console.log("inside javascript")
           var urlHere="${createLink(controller:"resource" ,action:"editread")}"
            ...
            <div class="container col-md-12" style="background: #31b0d5">
                ...
                <div class="col-md-7">
                    <table class="table">
                        <td width=200px>
                            <div class="input-group">
                             ...
                             %{--<div style="font-size: medium" >
                                    ${flash.message11} ${flash.message13} ${flash.message23}${flash.message}--}%%{--${flash.message4}--}%%{--
                                </div>--}%
                            </div>
                        </td>
                        ...
                        <td width=30px><asset:image src="${userdata.photo}"  height="38px" width="40px" style="margin-right: 10px;"></asset:image>%{--</a>--}%
                        </td>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <g:uploadForm  controller="topic" action="saveLink" class="topicForm">
                            Link *:
                            <g:field type="url" class="form-control" id="linkres"  placeholder="Link" name="linkres" required="true"></g:field>
                            <br>
                            Description *:
